...
| **ux-e2e** | `skills/ux-e2e/` | 端到端网页体验测评。覆盖客户旅程四阶段（感知→购买→使用→反馈），五层维度评估，含转化漏斗分析和 P0/P1/P2 问题清单 |
| **ux-comparative-workflow** | `skills/ux-comparative-workflow/` | 串行化竞品对比工作流。四步引导式流程：待测评对象 → 竞品采集 → 补充内容 → 输出含竞品对比矩阵的完整测评报告 |
...
hermes skills install wenchjun/ux/skills/ux-e2e
hermes skills install wenchjun/ux/skills/ux-comparative-workflow
